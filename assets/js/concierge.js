...
(function() {
    ...
    function executeRedirect(userQuery) {
        ...
        // Brief premium structural delay so user can digest the final AI confirmation message
        setTimeout(() => {
    ...
    const evaluateAIResponse = (input) => {
        ...
        if (query.includes('shoe') || query.includes('footwear') || query.includes('size') || query.includes('fit')) {
